...
function initialise()
	...
	print('LUA: Initialising LUA script.');
...
function drop(frame_nr, nal_nr, nal_type, nal_size, D, T, Q, pkt_size, pkt_n, pkt_c)
	...
	print('LUA: Pkt counter: ' .. pkt_counter);
	
	print('LUA: Frame number: ' .. frame_nr);
	print('LUA: NAL number: ' .. nal_nr);
	print('LUA: NAL type: ' .. nal_type);
	print('LUA: NAL size: ' .. nal_size);
	print('LUA: D/T/Q: ' ..'('..D..'/'..T..'/'..Q..')');
	print('LUA: Pkt size: ' .. pkt_size);
	print('LUA: Pkt nr/count: ' .. pkt_n .. '/' .. pkt_c );
